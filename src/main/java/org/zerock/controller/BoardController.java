...
//	}
	...
	private void deleteFiles(List<BoardAttachVO> attachList) {
	    ...
	    attachList.forEach(attach -> {
	      try {        
	        Path file  = Paths.get("F:\\ksseo\\upload\\"+attach.getUploadPath()+"\\" + attach.getUuid()+"_"+ attach.getFileName());
	        Files.deleteIfExists(file);
	        if(Files.probeContentType(file).startsWith("image")) {
	          Path thumbNail = Paths.get("F:\\ksseo\\upload\\"+attach.getUploadPath()+"\\s_" + attach.getUuid()+"_"+ attach.getFileName());

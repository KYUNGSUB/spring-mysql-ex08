...
//			File saveFile = new File(uploadFolder, uploadFileName);
	...
	*/
	...
	public ResponseEntity<byte[]> getFile(String fileName) {
		...
		File file = new File("F:\\ksseo\\upload\\" + fileName);
		log.info("file: " + file);
...
//		Resource resource = new FileSystemResource("F:\\ksseo\\upload\\" + fileName);
...
//	}
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		File file;
		try {
			file = new File("F:\\ksseo\\upload\\" + URLDecoder.decode(fileName, "UTF-8"));
			file.delete();
